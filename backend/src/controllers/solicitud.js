...
export const getEventos = async (req, res) => {
    ...
    const [filas] = await conexion.query('SELECT categoria_evento.categoria FROM evento LEFT JOIN categoria_evento ON categoria_evento.id_evento = evento.id WHERE evento.id = categoria_evento.id_evento and evento.estado = "Activo"');
    res.json(filas);
}
